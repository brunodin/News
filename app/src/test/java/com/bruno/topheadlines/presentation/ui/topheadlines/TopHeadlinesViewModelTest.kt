...
import com.bruno.topheadlines.presentation.ui.topheadlines.TopHeadlinesViewModel.RetryAction.GetNews
...
class TopHeadlinesViewModelTest {
    ...
    @Before
    fun setup() {
        viewModel = TopHeadlinesViewModel(getHeadlinesUseCase)
        prepareObservables()
    }
